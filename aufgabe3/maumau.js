...
document.addEventListener("DOMContentLoaded", function () {
    ...
    nachziehStapel.addEventListener("click", function () {
        ...
        let zufallsKarte = cards.splice(Math.round(Math.random() * (cards.length - 1)), 1)[0];
    ...
    for (let v = 0; v < handstack.length; v++) {
        //Karten von Hand in die Ablage
        handstack[v].addEventListener("click", function (event) {
