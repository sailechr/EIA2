...
(function (CANVAS4) {
    ...
    function drawTrees(_x, _y, _strokeColor, _fillColor) {
        //Baumstamm
        crc2.beginPath();
    ...
    //Funktion für zufällig herumfliegende Schneeflocken
    function drawrandomSnowflakes() {
        let numberofSnowflakes = 90;
        // draw randomly placed Snowflakes
        for (let n = 0; n < numberofSnowflakes; n++) {
            let x = 0.4 + (Math.random() * 770);
            let y = 1 + (Math.random() * 300);
            //Aufruf der Funktion innerhalb der for-schleife
            drawSnowflakes(x, y, "black", "whitesmoke");
        }
    }
