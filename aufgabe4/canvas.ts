...
namespace CANVAS4 {
    ...
    function init(): void {
        ...
        crc2.lineWidth = 6;
        let grad2: any = crc2.createLinearGradient(80, 330, 93, 80);
        ...
        let grad: any = crc2.createLinearGradient(80, 230, 96, 80);
         ...
         let colorArray: string []  = [];
            ...
            colorArray.push("tomato"); // 5
             ...
             for (let n: number = 0; n < numFlowers; n++) {
                 let centerX: any = (Math.random() * (1280 - 307) + 307);
                 let centerY: any = (Math.random() * (720 - 410) + 410);
...
function drawFlowers(context: any, centerX: any, centerY: any, radius: any, numPetals: any, color: any): void {
    context.beginPath();
